...
material=raw_input('1 = ABS or 2 = PLA or 3 = 3k CFRP or 4 = Plexiglass : ')
class STLUtils:
    ...
    def calculateVolume(self,infilename, unit):
        ...
        try:
            ...
            if totalMass == 0:
            	...
            	print('Total mass:', totalMass/1000, 'kg')
...
def get_stl_files():
    return glob.glob('*.stl') + glob.glob('*.STL')
...
def run():
    ...
    for stl in stls:
        mySTLUtils = STLUtils()
        mySTLUtils.calculateVolume(stl, "cm")
